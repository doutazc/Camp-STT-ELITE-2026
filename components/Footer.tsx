...
const Footer: React.FC = () => {
  return (
    <footer className="bg-stt-dark text-white pt-12 pb-8 border-t border-red-800">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex flex-col md:items-end justify-center">
             ...
             <div className="flex gap-6 items-center flex-wrap opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
                ...
                <div className="h-8 md:h-10 bg-white/20 rounded px-2 flex items-center justify-center text-xs font-bold w-24">GUBLER</div>
                <div className="h-8 md:h-10 bg-white/20 rounded px-2 flex items-center justify-center text-xs font-bold w-24">DONIC</div>
                <div className="h-8 md:h-10 bg-white/20 rounded px-2 flex items-center justify-center text-xs font-bold w-24">SWISS OLYMPIC</div>
             </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
           <p className="text-xs text-gray-600">
             © 2025 Swiss Table Tennis. Tous droits réservés.
           </p>
           <p className="text-xs text-gray-600">
